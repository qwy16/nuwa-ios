...
public final class NotificationService {
    ...
    public static let unreadShortcutItemIdentifier = "com.nuwasocial.app.NotificationService.unread-shortcut"
    
    var disposeBag = Set<AnyCancellable>()
    
    let workingQueue = DispatchQueue(label: "com.nuwasocial.app.NotificationService.working-queue")
